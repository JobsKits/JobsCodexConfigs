...
# - 核心用途：在 💻JobsCodexConfigs 中下载、登记和同步 JobsSkills 子模块。
# - 影响范围：可能修改当前父仓的 skills 工作树、.gitmodules、Git 索引和子模块指针。
...
SUBMODULE_REPO_URLS=(
  "https://github.com/JobsKits/JobsSkills|skills"
  # 以后新增仓库，只写浏览器页面地址即可。
  # "https://github.com/JobsKits/xxx"
)
...
show_script_intro_and_wait() {
  ...
  print -r -- '核心用途：在 💻JobsCodexConfigs 中下载、登记和同步 JobsSkills 子模块。'
  print -r -- '影响范围：可能修改当前父仓的 skills 工作树、.gitmodules、Git 索引和子模块指针。'
